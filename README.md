### Applitools Javascript Selenium SDK  
...
2.  Download the Example
    -  Option 1:  `git clone https://github.com/bmurmistro/applitools-hackathon-javascript-selenium`
    -  Option 2:  Download it as a Zip file and extract it
3.  Navigate to the recently cloned folder applitools-hackathon-javascript-selenium
    -  run `npm install`
4. Install ChromeDriver from [here](https://chromedriver.chromium.org/downloads) if you are running on mac, you can also install it using the brew,
...
5.  If you don't have an account with Applitools, register and [create an account](https://auth.applitools.com/users/register)
6.  Ensure you have your Applitools API Key! Set it in VisualAiTest.js. 
7.  Set your batch name in (VisualAiTest.js) to include your breakout team name. Can be the Team Leader's name if you don't think of anything. If you want to follow along on your own, simply put use your name.
8.  Set your App name (VisualAiTest.js) to the same team name. 
